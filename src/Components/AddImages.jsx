...
const AddImages = () => {
  ...
  return (
    ...
    }} className={`flex flex-col justify-center relative items-center border-4 ${isDarkMode ? 'border-white text-white' : 'border-black text-black'} border-dotted rounded-lg cursor-pointer m-auto p-12 sm:p-14 min-[375px]:w-52 min-[375px]:h-52 lg:p-10 sm:w-full sm:h-full w-fit h-full`}>
